...
export default function WorkingWithArrays() {
    ...
    return (
        <div id="wd-working-with-arrays">
            ...
            <h3>Updating description property of a todo</h3>
            <a href={`${API}/${todo.id}/description/${todo.description}`} className="btn btn-primary float-end">
                Update Description</a>
            <input value={todo.id} className="form-control w-25 float-start me-2"
                onChange={(e) => setTodo({ ...todo, id: e.target.value })} />
            <input value={todo.description} className="form-control w-25 float-start me-2"
                onChange={(e) => setTodo({ ...todo, description: e.target.value })} />
            <br /><br />
            <hr />
            <h3>Updating completed property of a todo</h3>

            <div className="form-check">
                <input value={todo.id} className="form-control w-25 float-start me-5"
                    onChange={(e) => setTodo({ ...todo, id: e.target.value })} />
                ...
                <a href={`${API}/${todo.id}/completed/${todo.completed}`} className="btn btn-primary float-end">Update Completed Property of todo</a>
            </div>
            <hr />
